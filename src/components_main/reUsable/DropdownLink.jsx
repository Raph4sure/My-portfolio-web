            ...
            <Popover placement="bottom" showArrow={true}>
                ...
                <PopoverContent>
                    <div className="px-1 py-2">
                        <div className="text-small font-medium flex flex-col text-black-100">
                            <a href={href1}className="text-black-100 underline-animation text-text-primary mb-3 hover:text-black-100/60 cursor-pointer">
                                {child1}
                            </a>
                            <a href={href2} className="text-black-100 underline-animation text-text-primary hover:text-black-100/60 cursor-pointer">
                                {child2}
                            </a>
                        </div>
