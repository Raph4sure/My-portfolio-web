            ...
            <div className="contact_form">
                <form onSubmit={handleSubmit} className={styles.form} noValidate>
                    ...
                    <ValidatedInput
                        ...
                        error={errors.name}
                        isSuccess={!errors.name && formData.name.length > 0}
                    />
                    ...
                    <ValidatedInput
                        ...
                        onChange={handleChange}
                        error={errors.email}
                        isSuccess={!errors.email && formData.email.length > 0}
                    />
                    ...
                    <ValidatedInput
                        ...
                        isSuccess={!errors.message && formData.message.length > 0}
...
//     return (
//         <div className="w-full bg-blue-400 h-screen grid justify-items-center text-xl" >
//             <h1>Contact Me</h1>
//             <div className="grid gap-1 my-5">
//                 <div className="w-[95%] h-full flex flex-col gap-4 justify-self-center px-4 py-2 rounded-2xl bg-amber-500 ">
//                     <div className="flex justify-center h-full">
//                         <form action="" ref={form} onSubmit={sendEmail}>
//                             <h1 className="text-2xl font-[500] text-center tablet:text-[1rem]">
