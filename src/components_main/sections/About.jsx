        ...
        <div className="grid grid-rows-[auto_1fr_auto] h-screen">
            <div>
                ...
                <p className="text-[1rem] text-justify w-[95%] mx-auto -mb-30">
                    Am a highly motivated and focused technology professional
                    with expertise in developing scalable solutions, analyzing
                    complex data, and delivering innovative software
